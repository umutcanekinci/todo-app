...
OPEN_TITLE_RECT =        Rect(OPEN_RECT.centerX - 25,        OPEN_RECT.y + PADDING)
IN_PROGRESS_TITLE_RECT = Rect(IN_PROGRESS_RECT.centerX - 75, IN_PROGRESS_RECT.y + PADDING)
DONE_TITLE_RECT =        Rect(DONE_RECT.centerX - 25,        DONE_RECT.y + PADDING)
